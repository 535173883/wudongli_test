...
//监听地图图层--
export function AddZoomListener(map, callback) {
...
//定位坐标 转化成3857坐标系--
export function SetPosition(map, location, zoomexpansion = true) {
  let position = transform(
    [location.lon / 60 / 10000, location.lat / 60 / 10000],
    "EPSG:4326",
    "EPSG:3857"
  );
